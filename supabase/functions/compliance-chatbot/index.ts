...
serve(async (req) => {
  ...
  try {
    ...
    Seja objetivo, claro e sempre cite as bases regulamentares quando responder. 
    Se não souber algo específico, seja honesto e recomende consultar o departamento de compliance.`;
